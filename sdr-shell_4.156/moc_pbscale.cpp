...
**
** Created: Wed Aug 31 23:40:20 2011
...
int PassBandScale::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: set_lower_pb((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: set_upper_pb((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: movement((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 3;
    }
