...
sdr-shell.xcodeproj/project.pbxproj: sdr-shell.pro  /usr/local/Qt4.7/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.7/mkspecs/common/unix.conf \
	...
	$(QMAKE) -o sdr-shell.xcodeproj/project.pbxproj sdr-shell.pro
