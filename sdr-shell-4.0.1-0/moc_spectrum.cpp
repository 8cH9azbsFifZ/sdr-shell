...
**
** Created: Sun Aug 28 02:17:46 2011
...
int Spectrum::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: movement((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: tune((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: tune2((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: tune3((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 4;
    }
